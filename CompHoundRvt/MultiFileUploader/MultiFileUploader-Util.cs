...
namespace MultiFileUploader
{
  public class Util
  {
    ...
    public string UploadFilesAndSetReference(string bucketName,
                                            string accessToken,
                                            ArrayList files,
                                            string rootFile,
                                            bool showInBrowser)
    {
      ...
      if (files.Count > 0)
      {
        ...
        foreach (string file in files)
        {
          ...
          // Put the name of the file being uploaded in the text box on the main form
